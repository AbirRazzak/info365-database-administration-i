...
//
// Create INSERT statements for Other Tables
//

$other_tables_file = "/home/user/PA4.1/CollegeScorecard_OtherTables.csv";
...
file_put_contents('/home/user/PA4.1/create_other_tables.sql',$create_other_tables);
file_put_contents('/home/user/PA4.1/insert_other_tables.sql',$insert_other_tables);
...
//
$csv_file = "/home/user/PA4.1/CollegeScorecard_DataDictionary.csv";
...
file_put_contents('/home/user/PA4.1/create_tables.sql',$create_schema);
...
$csv_file = "/home/user/PA4.1/MERGED2016_17_PP.csv";
...
// Column/Value List:
					...
					foreach ($columns as $column => $attributes) {
						if (trim($column) <> '' && trim($column) <> 'OPEID') {
							...
							if ($csv_row[$column] == 'NULL' || $csv_row[$column] == 'PrivacySuppressed' ||
								$csv_row[$column] == '') {
